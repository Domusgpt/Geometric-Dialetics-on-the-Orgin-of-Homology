...
A fundamental relationship exists between E8 and H4: the E8 root system can be ``folded'' or projected to produce H4 polytope vertices with golden ratio scaling. This connection has been studied by numerous authors \cite{conway1999, moxness2014, koca2012}. Specifically, an $8 \times 8$ projection matrix can map the 240 roots of E8 to produce multiple copies of the 120-vertex 600-cell at scales related by powers of $\varphi$.
...
\begin{definition}
The \textbf{H4 Coxeter group} is the symmetry group of the 600-cell, a regular 4-dimensional polytope with 120 vertices. The 600-cell's vertex coordinates necessarily involve the golden ratio.
\end{definition}
...
\bibitem{koca2012}
M. Koca, N.O. Koca, and R. Ko\c{c},
``Quaternionic roots of E8 related Coxeter graphs and quasicrystals,''
\textit{Turkish Journal of Physics}, vol.~22, pp.~421--435, 1998.

\bibitem{denney2020}
T. Denney, D. Hooker, T. Johnson, G. Robinson, N. Shams, and P. Winger,
``The 600-cell,''
arXiv:2003.00655, 2020.
